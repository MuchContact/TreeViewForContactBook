...
public interface ITreeViewHeaderUpdater {
     ...
     * @param childPosition The child position. * @return {@link #STATE_GONE}, {@link #STATE_VISIBLE_ALL}, * {@link #STATE_VISIBLE_PART} */ public int getHeaderState(int groupPosition, int childPosition);
    /**
